...
const ContactInfo = () => {
  const info = [
    { icon: MapPin, title: 'Visit Us', desc: contactData.address },
    {
      icon: Phone,
      title: 'Call Us',
      desc: `${contactData.phone} (${contactData.hours})`,
    },
    { icon: Mail, title: 'Email Us', desc: contactData.email },
    {
      icon: Clock,
      title: 'Working Hours',
      desc: '24/7 Monitoring, Support: 9am-8pm IST',
    },
  ];
          ...
          >
            ...
            <div className="p-8 rounded-[2rem] bg-primary text-white relative overflow-hidden">
              ...
              <p className="text-white/80 mb-6">
                Need help setting up your QR codes? Our team can guide you
                through the process in under 10 minutes.
              </p>
  ...
  <section className="py-24 bg-gray-50/50">
    <div className="container mx-auto px-6 max-w-4xl">
      <SectionTitle
        ...
        subtitle="Quick answers for local outlet owners."
      />
