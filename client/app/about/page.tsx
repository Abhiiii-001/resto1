      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight text-foreground mb-8 leading-[1.1]">
            Empowering the <span className="text-primary">Local Cafe</span>{' '}
            Hero.
          </h1>
    ...
    <section className="py-24 bg-white">
      <div className="container mx-auto px-6">
        <SectionTitle
          ...
          subtitle="A small, dedicated team building the future of local dining."
        />
        ...
        <div className="container mx-auto px-6">
          <div className="bg-primary rounded-[2rem] p-12 md:p-20 text-center text-white relative overflow-hidden">
            ...
            <p className="text-xl text-white/80 mb-12 max-w-2xl mx-auto">
              We're looking for more local cafes and outlets to join our mission
              of frictionless dining.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/signup">
                <Button
                  size="lg"
                  className="h-14 px-10 text-lg font-bold bg-white text-primary hover:bg-white/90"
                >
