      ...
      <main className="flex-grow pt-32 pb-20">
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          <div className="bg-white p-8 rounded-xl border border-border shadow-sm space-y-6 text-muted-foreground leading-relaxed">
            ...
            <p>
              By accessing and using Restro ("the Service"), you accept and agree to be bound by the terms and provision of this agreement. If you do not agree to abide by these terms, please do not use this Service.
            </p>

            <h2 className="text-2xl font-bold text-foreground mt-8 mb-4">2. Description of Service</h2>
            <p>
              Restro provides a digital QR-based menu and ordering platform for restaurants, cafes, and food outlets. The service includes table management, menu digitization, and live order tracking.
            </p>
            ...
            <h2 className="text-2xl font-bold text-foreground mt-8 mb-4">4. Account Responsibilities</h2>
            <p>
              You are responsible for maintaining the confidentiality of your account and password and for restricting access to your computer. You agree to accept responsibility for all activities that occur under your account or password.
            </p>

            <h2 className="text-2xl font-bold text-foreground mt-8 mb-4">5. Modifications to Service</h2>
            <p>
              Restro reserves the right at any time to modify or discontinue, temporarily or permanently, the Service (or any part thereof) with or without notice.
            </p>
          </div>
        </div>
      </main>
