    ...
    <div className="min-h-screen bg-white flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="max-w-2xl w-full text-center relative z-10">
        ...
        >
          ...
          <h1 className="text-8xl md:text-9xl font-black text-primary mb-4 opacity-20 select-none">
            404
          </h1>
          ...
          <p className="text-lg text-muted-foreground mb-12 max-w-md mx-auto leading-relaxed">
            It seems like the page you are looking for has been taken off the
            menu. Don't worry, our kitchen is still open!
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="/">
              <Button
                size="lg"
                className="h-14 px-8 text-lg font-bold bg-primary hover:bg-primary/90 min-w-[200px]"
              >
