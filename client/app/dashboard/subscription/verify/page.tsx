    ...
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-white">
      ...
      {status === 'success' && (
        <div className="text-center space-y-6 animate-in zoom-in duration-500">
          ...
          <p className="text-zinc-400">
            Your subscription has been activated. Redirecting you to the
            dashboard...
          </p>
        </div>
      )}
      ...
      {status === 'failed' && (
        <div className="text-center space-y-6 animate-in zoom-in duration-500">
          ...
          <p className="text-zinc-400">
            We couldn&apos;t verify your payment. If the amount was deducted, it
            will be refunded or updated soon.
          </p>
          <button
