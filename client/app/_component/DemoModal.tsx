...
const DEMO_ACCOUNTS = {
  RESTAURANT: {
    ...
    description: 'Full administrative access: oversee finances, manage plans, toggle shop hours, manage menus & employees.',
    icon: Award,
    email: process.env.NEXT_PUBLIC_DEMO_RESTAURANT_EMAIL || 'owner@royalbistro.com',
  ...
  MANAGER: {
    ...
    description: 'Operational leadership: full control of live orders, adding employees, managing categories & products.',
    icon: ShieldAlert,
    email: process.env.NEXT_PUBLIC_DEMO_MANAGER_EMAIL || 'admin@royalbistro.com',
  ...
  STAFF: {
    title: 'Normal Staff',
    description: 'Counter & Kitchen view: process incoming live orders, update statuses, and view ticket summaries.',
    icon: User,
          ...
          >
            ...
            <div className="p-8">
              ...
              <div className="mb-6 flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-2xl font-bold tracking-tight text-slate-900">Choose a Demo Role</h3>
                  <p className="text-sm text-slate-500">Explore Restro instantly with auto-generated credentials</p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                {(Object.keys(DEMO_ACCOUNTS) as Array<keyof typeof DEMO_ACCOUNTS>).map((key) => {
                  ...
                  return (
                    ...
                    >
                      <div className={`mt-0.5 flex h-10 w-10 shrink-0 items-center justify-center rounded-xl transition-all duration-300 ${account.iconColor} group-hover:scale-110`}>
                      ...
                      <div className="flex-1">
                        <div className="flex items-center justify-between">
                          ...
                          <span className={`text-[10px] font-bold uppercase tracking-wider text-white px-2 py-0.5 rounded bg-gradient-to-r ${account.color}`}>
                            Quick Access
                          </span>
                        </div>
